...
module "vpc" {
  ...
  # Enable auto-assignment of public IPv4 addresses on public subnets
...
resource "aws_vpc_endpoint" "dynamodb" {
  ...
  route_table_ids   = module.vpc.private_route_table_ids
  tags = {
    Name = "${var.vpc_name}-dynamodb-vpc-endpoint"
  }
}
...
resource "aws_vpc_endpoint" "ssm" {
  ...
  ip_address_type     = "ipv4"
  tags = {
    Name = "${var.vpc_name}-ssm-vpc-endpoint"
  }
}
...
resource "aws_vpc_endpoint" "ssmmessages" {
  ...
  ip_address_type     = "ipv4"
  tags = {
    Name = "${var.vpc_name}-ssmmessages-vpc-endpoint"
  }
}